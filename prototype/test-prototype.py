...
from prototype.llm import OllamaUnavailable, OllamaAdapter
...
class UnavailableOllama(OllamaAdapter):
    def __init__(self):
        super().__init__(model="offline-model")
...
class CognitiveDnaTests(unittest.TestCase):
    ...
    def test_ollama_communication_uses_cognitive_context(self):
        ...
        self.assertEqual("fakeollama", state.trace[9]["output"]["source"])
